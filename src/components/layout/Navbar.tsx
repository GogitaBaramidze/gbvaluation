...
import { Phone, Mail, Menu, X, Globe, ChevronDown, Check } from "lucide-react";
      ...
      <div className="bg-brand-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between h-10">
          <div className="hidden lg:flex items-center gap-5">
            ...
            <a href="https://wa.me/995555123456" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://t.me/gbvaluation" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-white/60 text-xs hover:text-white transition-colors">
            ...
            <a href="https://facebook.com/gbvaluation" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-white/60 text-xs hover:text-white transition-colors">
            ...
            <a href="mailto:info@gbvaluation.ge"
              className="flex items-center gap-1.5 text-white/60 text-xs hover:text-white transition-colors">
              <Mail size={11} />
              info@gbvaluation.ge
            </a>
        ...
        <div className="lg:hidden bg-white border-t border-zinc-100 shadow-lg">
          <nav className="max-w-7xl mx-auto px-6 py-4 flex flex-col gap-1">
            ...
            <div className="mt-4 pt-4 border-t border-zinc-100 space-y-2">
              ...
              <a href="mailto:info@gbvaluation.ge" className="flex items-center gap-2 text-xs text-zinc-400">
                <Mail size={12} /> info@gbvaluation.ge
              </a>
            </div>
          </nav>
        </div>
